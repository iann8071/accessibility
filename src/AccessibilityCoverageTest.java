...
public class AccessibilityCoverageTest {
	FirefoxDriver driver;
	String baseUrl = "http://localhost/moodle";
	...
	public void initDatabase() throws Exception {
		...
		Runtime.getRuntime()
				.exec(new String[] {
						"sh",
						"-c",
						"mysql -u root -proot wordpress < /home/ubuntu/google-calendar-widget/sql/wordpress.sql" });
	}
